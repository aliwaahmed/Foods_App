...
import com.logapps.foods_app.rest.Rest_ratingActivity;

import java.util.HashMap;
import java.util.Map;

public class Person_rateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_rate);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(Person_rateActivity.this, "successfully rated", Toast.LENGTH_SHORT).show();

                                    Intent i = new Intent(Person_rateActivity.this , Person_Home_Activity.class);
                                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                    startActivity(i);

                                } else {

                                    Toast.makeText(Person_rateActivity.this, "Error", Toast.LENGTH_SHORT).show();
