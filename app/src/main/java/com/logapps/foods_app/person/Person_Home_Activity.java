...
import com.logapps.foods_app.charity.Charity_Home_Activity;
import com.logapps.foods_app.charity.Charity_rateActivity;
...
public class Person_Home_Activity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.menu_prifile){
            Intent i = new Intent(Person_Home_Activity.this , Profile_Activity.class);
            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(i);

        }else if (item.getItemId() == R.id.menu_rating){
            Intent i = new Intent(Person_Home_Activity.this , Person_rateActivity.class);
            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(i);
