    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder alert = new AlertDialog.Builder(Profile_Activity.this);
                ...
                mUserDatabase.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String info_name = dataSnapshot.child("name").getValue().toString();
                        String info_phone = dataSnapshot.child("phone").getValue().toString();
                        String info_add = dataSnapshot.child("address").getValue().toString();
                ...
                Dsave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mProgress = new ProgressDialog(Profile_Activity.this);
                        ...
                        mUserDatabase.child("name").setValue(DoctorName).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                        ...
                        mUserDatabase.child("phone").setValue(DoctorPhone).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                        ...
                        mUserDatabase.child("address").setValue(DoctorAddress).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String Iaddress = dataSnapshot.child("address").getValue().toString();
